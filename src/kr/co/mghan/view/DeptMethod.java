...
public class DeptMethod extends CommonMethod
{
	public void dept_All_View(DeptBean[] ar_db)
	{
		...
		for (int i = 0; i < ar_db.length; i++)
		{
			...
			System.out.println("사원번호 : " + ar_db[i].getDeptno());
			System.out.println("사원이름 : " + ar_db[i].getDeptname());
			System.out.println("부서번호 : " + ar_db[i].getLoc());
			System.out.println();
		} // for end
	...
	public DeptBean[] mod_dept(int e_deptno, String e_deptname, String e_loc, DeptBean[] ar_db, int target)
	{
		// 수정 진행
